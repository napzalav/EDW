...
<body>
  ...
  echo "<p><b>Utilizando un foreach se puede visualizar la lista de tipos de usuario, son 5:</b></p>";
  ...
  echo "<p><b>De la misma forma se pueden visualizar los valores almacenados en el array:</b></p>";
